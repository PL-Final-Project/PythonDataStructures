...
def t_reserved(t):
    r'ArrayStack | SinglyLinkedList | CircularDoublyLinkedList | ArrayList | Set | Bag | Map | HashTableSC | HashTableOA | DoublyLinkedQueue | print | use | add | None | StringComp | NumberComp | BinarySearchTree | SortedArrayList | True | False '
