...
from Structs.MapInterface import MapInterface
from Structs.MapEntry import MapEntry
...
class HashTableOA(MapInterface):
    ...
    def get(self, key) -> object:
        ...
        if elementFirstPosition.isStatus() is True and elementFirstPosition.getKey() == key:
        ...
        if elementSecondPosition.isStatus() is True and elementSecondPosition.getKey() == key:
        ...
        if elementThirdPosition.isStatus() is True and elementThirdPosition.getKey() == key:
        ...
        while tempIndex != self.linearHashFunction(key, self.buckets):
            if self.buckets[tempIndex].isStatus() is True and self.buckets[tempIndex].getKey() == key:
    ...
    def __reallocate(self):
        ...
        temp = HashTableOA( self.keyComparator, self.valueComparator, temporalSize)
