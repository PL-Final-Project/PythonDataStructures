...
_lr_productions = [
  ...
  ('Program -> Declaration','Program',1,'p_Program','release_parser.py',68),
  ('Program -> Program Separator Declaration','Program',3,'p_Program','release_parser.py',69),
  ('Program -> Program Separator Action','Program',3,'p_Program','release_parser.py',70),
  ('Action -> use Id Assign add Prim','Action',5,'p_Action','release_parser.py',80),
  ('Action -> use Id Assign add Tuples','Action',5,'p_Action','release_parser.py',81),
  ('Action -> use Id Assign remove Prim','Action',5,'p_Action','release_parser.py',82),
  ('Action -> use Id Assign remove Tuples','Action',5,'p_Action','release_parser.py',83),
  ('Action -> use Id Assign contains Prim','Action',5,'p_Action','release_parser.py',84),
  ('Action -> use Id Assign contains Tuples','Action',5,'p_Action','release_parser.py',85),
  ('Action -> use Id Assign clear','Action',4,'p_Action','release_parser.py',86),
  ('Action -> use Id Assign get Prim','Action',5,'p_Action','release_parser.py',87),
  ('Action -> use Id Assign get Tuples','Action',5,'p_Action','release_parser.py',88),
  ('Action -> use Id Assign get index Assign Int','Action',7,'p_Action','release_parser.py',89),
  ('Action -> use Id Assign removeAll Prim','Action',5,'p_Action','release_parser.py',90),
  ('Action -> use Id Assign removeAll Tuples','Action',5,'p_Action','release_parser.py',91),
  ('Action -> print Id','Action',2,'p_Action','release_parser.py',92),
  ('Declaration -> InputOptionalStruct LT Elements GT','Declaration',4,'p_Declaration','release_parser.py',121),
  ('Declaration -> InputRequiredStruct LT Elements GT','Declaration',4,'p_Declaration','release_parser.py',122),
  ('Declaration -> Structures Id Assign LT Elements GT','Declaration',6,'p_Declaration','release_parser.py',123),
  ('Declaration -> InputOptionalStruct LT GT','Declaration',3,'p_Declaration','release_parser.py',124),
  ('Declaration -> InputRequiredStruct LT GT','Declaration',3,'p_Declaration','release_parser.py',125),
  ('Declaration -> Structures Id Assign LT GT','Declaration',5,'p_Declaration','release_parser.py',126),
  ('Tuples -> LP Prim Separator Prim RP','Tuples',5,'p_Tuples','release_parser.py',183),
  ('Elements -> Prim','Elements',1,'p_Elements','release_parser.py',191),
  ('Elements -> Elements Separator Elements','Elements',3,'p_Elements','release_parser.py',192),
  ('Elements -> Tuples','Elements',1,'p_Elements','release_parser.py',193),
  ('Prim -> Bool','Prim',1,'p_Prim','release_parser.py',210),
  ('Prim -> Int','Prim',1,'p_Prim','release_parser.py',211),
  ('Prim -> Id','Prim',1,'p_Prim','release_parser.py',212),
  ('Prim -> String','Prim',1,'p_Prim','release_parser.py',213),
  ('Structures -> DLQ','Structures',1,'p_Structures','release_parser.py',219),
  ('Structures -> Map','Structures',1,'p_Structures','release_parser.py',220),
  ('Structures -> AL','Structures',1,'p_Structures','release_parser.py',221),
  ('Structures -> CDLL','Structures',1,'p_Structures','release_parser.py',222),
  ('Structures -> AS','Structures',1,'p_Structures','release_parser.py',223),
  ('Structures -> Set','Structures',1,'p_Structures','release_parser.py',224),
  ('Structures -> Bag','Structures',1,'p_Structures','release_parser.py',225),
  ('Structures -> SLL','Structures',1,'p_Structures','release_parser.py',226),
  ('InputRequiredStruct -> Tree Id Assign LP Comparator RP','InputRequiredStruct',6,'p_InputRequiredStruct','release_parser.py',245),
  ('InputRequiredStruct -> SArrayList Id Assign LP Comparator Separator Comparator RP','InputRequiredStruct',8,'p_InputRequiredStruct','release_parser.py',246),
  ('InputOptionalStruct -> HSOA Id Assign LP Comparator Separator Comparator RP','InputOptionalStruct',8,'p_InputOptionalStruct','release_parser.py',257),
  ('InputOptionalStruct -> HSSC Id Assign LP Comparator Separator Comparator RP','InputOptionalStruct',8,'p_InputOptionalStruct','release_parser.py',258),
  ('InputOptionalStruct -> HSSC Id Assign LP RP','InputOptionalStruct',5,'p_InputOptionalStruct','release_parser.py',259),
  ('InputOptionalStruct -> HSOA Id Assign LP RP','InputOptionalStruct',5,'p_InputOptionalStruct','release_parser.py',260),
  ('Comparator -> NumberComp','Comparator',1,'p_Comparator','release_parser.py',279),
  ('Comparator -> StringComp','Comparator',1,'p_Comparator','release_parser.py',280),
  ('Id -> character','Id',1,'p_Id','release_parser.py',290),
  ('Id -> Id digit','Id',2,'p_Id','release_parser.py',291),
  ('Id -> Id character','Id',2,'p_Id','release_parser.py',292),
  ('Bool -> True','Bool',1,'p_Bool','release_parser.py',303),
  ('Bool -> False','Bool',1,'p_Bool','release_parser.py',304),
  ('Int -> digit','Int',1,'p_Int','release_parser.py',314),
  ('Int -> Int digit','Int',2,'p_Int','release_parser.py',315),
  ('String -> Comillas Prim Comillas','String',3,'p_String','release_parser.py',326),
  ('String -> Comillas Tuples Comillas','String',3,'p_String','release_parser.py',327),
]
