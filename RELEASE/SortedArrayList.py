...
from ListInterface import SortedListInterface as Interface
...
class SortedArrayList(Interface):
    ...
    def get_index(self, index):
        try:
            ...
            release_parser.messages.append(("IndexOutOFBounds"))
            return None
    ...
    def remove_index(self, index):
        try:
            ...
            release_parser.messages.append((error))
            return False
    ...
    def printValues(self):
        for element in self.elements:
            if element is not None:
                release_parser.messages.append((element))
